...
def main(): 
    ...
    save_output_path = "/scratch4/rsteven1/ADC_coregis_20231228"
    ...
    for unique_id in ids:
        ...
        moving_ADC_path = os.path.join(dwi_dir, dwi_id, f'{dwi_id}_ADC_MNI.nii.gz')
        ...
        moving_DWI = sitk.ReadImage(moving_ADC_path)
        ...
        save_sample_path = f'/home/bruno/3D-Laision-Seg/GenrativeMethod/co_regis/save/{unique_id}.png'
        plot_and_save(b0_img, DWI_transformed, label_transformed, save_sample_path)

        ADC_name = f'{unique_id}_ADC_coregis.nii.gz'
        sitk.WriteImage(DWI_transformed, os.path.join(save_output_path, ADC_name))
        print('saved one ')
